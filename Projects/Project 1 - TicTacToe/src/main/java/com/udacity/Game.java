...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
        ...
        //Check if horizontal or vertical or diagonal x occurs.
        if ( searchTarget(grid,'o'))
        {
            return "O wins";
        }
        else if (searchTarget(grid,'x')){
            return "X wins";
        }
        else if (traverse(grid))
        {
            return "Tie";
        }
        else
    ...
    public boolean traverse(char [][]grid){
       for (int i=0;i<3;i++){
           for (int j=0;j<3;j++){
    ...
    public boolean searchTarget(char [][]grid,char target){
        ...
        if ((( grid[0][0] == target) && (grid[1][1] == target) && (grid[2][2] == target ) ) || ( ( grid[0][2] == target) && (grid[1][1] == target) && (grid[2][0] == target ))) {
            return true;
        }
        else {
            return false;
